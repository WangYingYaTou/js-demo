  ...
  ***************************************************************************** */
  ...
  var Hub = /** @class */ (function () {
    ...
    Hub.prototype.captureException = function (exception, hint) {
      ...
      this.invokeClientAsync('captureException', exception, __assign({}, hint, {
        event_id: eventId
      }));
      return eventId;
    };
    ...
    Hub.prototype.captureMessage = function (message, level, hint) {
      var eventId = (this._lastEventId = uuid4());
      this.invokeClientAsync('captureMessage', message, level, __assign({}, hint, {
        event_id: eventId
      }));
      return eventId;
    };
    ...
    Hub.prototype.captureEvent = function (event, hint) {
      var eventId = (this._lastEventId = uuid4());
      this.invokeClientAsync('captureEvent', event, __assign({}, hint, {
        event_id: eventId
      }));
      return eventId;
    };
  ...
  var BaseClient = /** @class */ (function () {
    ...
    BaseClient.prototype.captureException = function (exception, hint, scope) {
      return __awaiter(this, void 0, void 0, function () {
        var _this = this;
        return __generator(this, function (_a) {
          return [2 /*return*/ , this.buffer((function () {
  ...
  TraceKit.computeStackTrace = (function computeStackTraceWrapper() {
    ...
    function computeStackTraceFromStackProp(ex) {
      ...
      var chrome = /^\s*at (?:(.*?) ?\()?((?:file|https?|blob|chrome-extension|native|eval|webpack|<anonymous>|[a-z]:|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i,
        ...
        isEval, geckoEval = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i,
        chromeEval = /\((\S*)(?::(\d+))(?::(\d+))\)/,
        lines = ex.stack.split('\n'),
        stack = [],
        submatch, parts, element, reference = /^(.*) is undefined$/.exec(ex.message);
          ...
          switch (_a.label) {
            ...
            case 7:
              event = __assign({}, event, {
                ...
                exception: __assign({}, event.exception, {
                  mechanism: {
                    handled: true,
                    type: 'generic',
                  }
              ...
              scope.addEventProcessor(function (event) {
                return __awaiter(_this, void 0, void 0, function () {
                  ...
                  return __generator(this, function (_a) {
                    ...
                    processedEvent.extra = __assign({}, processedEvent.extra, {
        ...
        return __awaiter(_this, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            if (getCurrentHub().getIntegration(UserAgent)) {
              ...
              return [2 /*return*/ , __assign({}, event, {
                request: request
              })];
            }
            return [2 /*return*/ , event];
        ...
        return __awaiter(_this, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            if (event.sdk) {
              ...
              event.sdk = __assign({}, event.sdk, {
                integrations: __spread(integrations, ['ember'])
              });
            }
            return [2 /*return*/ , event];
          });
              ...
              return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                  if (event.sdk) {
                    integrations = event.sdk.integrations || [];
                    event.sdk = __assign({}, event.sdk, {
                      integrations: __spread(integrations, ['vue'])
                    });
                  }
                  return [2 /*return*/ , event];
                });
