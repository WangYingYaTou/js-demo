...
var _initState = __webpack_require__(202);
...
function postsBySubreddit() {
  ...
  switch (action.type) {
    ...
    case _actions.RECEIVE_POSTS:
    case _actions.REQUEST_POSTS:
      return (0, _assign2.default)({}, state, (0, _defineProperty3.default)({}, action.subreddit, posts(state[action.subreddit], action)));
    default:
      return state;
  }
}
...
exports.INVALIDATE_SUBREDDIT = exports.RECEIVE_POSTS = exports.REQUEST_POSTS = exports.SELECT_SUBREDDIT = undefined;
...
var _crossFetch = __webpack_require__(201);
